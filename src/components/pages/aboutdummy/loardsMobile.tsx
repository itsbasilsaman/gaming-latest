...
import BrawlCards from '../../../assets/Card/imgThreethree.png';
import React, { useState } from 'react';
import { IoSearchSharp } from "react-icons/io5";
import Icon from '../../../assets/Images/chevron-down.png';
import { CiHeart } from "react-icons/ci";
import { Link } from 'react-router-dom';
function LoardsMobile() {
  ...
  return (
    <> 
      ...
      <p className='lg:pt-[130px] pt-[110px]  lg:pb-[40px] pb-[20px]  text-left w-[100%]'>Home / Games / Loards Mobile</p>
      <div className='  w-[100%] lg:h-[182px] h-[154px] gamecard-box rounded-[13px] relative lg:px-[15px] flex lg:justify-between  ' >
         ...
         <div className='flex  lg:flex-row flex-col justify-center lg:items-center pb-[25px] lg:pt-[0px]   pt-[18px] lg:pb-[0px] lg:gap-[25px] gap-[15px] w-[100%] lg:w-auto px-[20px] lg:px-[0px]'>
            <h1 className='lg:text-[40px] text-[30px] font-bold' style={{fontFamily:'Unbounded'}}>Loards Mobile</h1>
      ...
      <div className='top-up-section lg:gap-[19px] lg:pt-[25px]  pt-[5px] pb-[25px]'  >
         <section className='lg:h-[125px] rounded-[16px]  top-up-box p-[19px] flex flex-col justify-between'>
           ...
           <div className='flex justify-between items-center'>
             <p className='game-offer-button py-[6px] px-[8px] rounded-[8px]'>102 Offer</p>
             <p className='font-semibold text-[22px]' style={{color:'rgba(0, 255, 121, 1)'}}>101.23 USD</p>
           </div>
         </section>
         <section className='lg:h-[125px] rounded-[16px]  top-up-box p-[19px] flex flex-col justify-between'>
           <div className='flex justify-between'>
         ...
         <section className='lg:h-[125px] rounded-[16px]  top-up-box p-[19px] flex flex-col justify-between'>
           ...
           <div className='flex justify-between items-center'>
             ...
             <p className='font-semibold text-[22px]' style={{color:'rgba(0, 255, 121, 1)'}}>141.23 USD</p>
           </div>
         </section>
         <section className='lg:h-[125px] rounded-[16px]  top-up-box p-[19px] flex flex-col justify-between'>
           <div className='flex justify-between'>
