...
export const Navbar: React.FC = React.memo(() => {
  ...
  return (
    <>
      <div
        className="flex justify-center fixed items-center text-white lg:px-[90px] px-[30px] h-[90px] lg:gap-[20px] gap-[18px] header fixed top-0 left-0 w-full "
      ...
      >
        <Link to={"/"}>
          <div className="text-[19px] font-semibold flex justify-center items-center">
            ...
            <span className="text-[22px] ">GATE </span>
          </div>
        </Link>
        ...
        <div className="flex justify-center items-center lg:gap-[20px] hidden lg:flex">
          ...
          {isLoggedUserWithSeller ? (
                      <Link to={"/user/selectDetailsOffer"}>
                        <button className="px-[20px] lg:h-[56px] country-button rounded-[1000px] lg:text-[17px] ">
                          Create Offer
                        </button>
                      </Link>
                    ) : (
