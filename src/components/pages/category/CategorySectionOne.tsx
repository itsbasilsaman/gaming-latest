        ...
        <section className="w-[100%] h-auto category-section lg:gap-[25px] md:px-[80px] px-[20px] ">
          <div className="category-section-one rounded-[16px] lg:px-[34px] px-[16px] py-[36px] w-full my-[15px] lg:my-[0px]">
            ...
            <p className="pb-[8px] lg:pb-[0px]">
              Fill Up Order Form And Provide Details Like This
            </p>
            <p>
              {" "}
              ➤ <span className="font-semibold">Account Box</span>: Write There
              Your Game Account Linked / Connect Mail Adress.{" "}
            </p>
            <p>
              ➤ <span className="font-semibold">Password Box</span>: Type
              Anything No Need Account Password.
            </p>
            <p>
              {" "}
              ➤ <span className="font-semibold">Username Box</span>: Your Game
              Account Name{" "}
            </p>
            <p>
              ➤ <span className="font-semibold">Server Id Box</span>: Type
              Supercell Id Please send us your email registered with Supercell
              and login code How to take log in code: Log out Supercell account
              ingame Log in Game will send 6 digits code to email Send us that
              code.
            </p>
          </div>
